...
import { ArrowLeft, Send, Phone, Mail, Globe, Building2, CheckCircle, XCircle } from 'lucide-react';
...
export default function AdminConversationPage() {
  ...
  const handleSend = async () => {
    ...
    const tempMsg = { _id: `temp-${Date.now()}`, senderRole: 'admin', body: reply, createdAt: new Date().toISOString() };
